<nav class="navbar navbar-default menuBarBase menuBarTop">
  <div class="container-fluid" style="padding:0px">
    <div class="navbar-header menuBarBase">
      ...
      <a class="navbar-brand menuBarBase" href="index.php">
        <img alt="Bang" src="https://cdn.rawgit.com/Bang3DEngine/Bang/061e2210/EngineAssets/Logos/LogoBang_B.svg"
             style="height:30px;">
      </a>
    </div>

    <div class="collapse navbar-collapse menuBarBase" id="myNavbar">
